...
test_directory="/wrk/xhdhdnobkup5/mtakasi/XRT/tests/unit-tests/xclbinutil/signing-xclbin_DER"
...
then
   /wrk/xhdhdnobkup5/mtakasi/XRT/src/runtime_src/tools/xclbinutil/unittests/signXclbinDER.py >> "$log_file" 2>&1
  errorCode=$?
fi
