...
test_directory="/wrk/xhdhdnobkup5/mtakasi/XRT/tests/unit-tests/xclbinutil/bmc"
...
then
   /wrk/xhdhdnobkup5/mtakasi/XRT/src/runtime_src/tools/xclbinutil/unittests/BMC/BMCSection.py  --resource-dir /wrk/xhdhdnobkup5/mtakasi/XRT/src/runtime_src/tools/xclbinutil/unittests/BMC >> "$log_file" 2>&1
  errorCode=$?
fi
