...
test_directory="/wrk/xhdhdnobkup5/mtakasi/XRT/tests/unit-tests/xclbinutil/binary-images"
...
then
   /wrk/xhdhdnobkup5/mtakasi/XRT/src/runtime_src/tools/xclbinutil/unittests/BinaryImages/BinaryImages.py  --resource-dir /wrk/xhdhdnobkup5/mtakasi/XRT/src/runtime_src/tools/xclbinutil/unittests/BinaryImages >> "$log_file" 2>&1
  errorCode=$?
fi
