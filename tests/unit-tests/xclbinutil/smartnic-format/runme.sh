...
test_directory="/wrk/xhdhdnobkup5/mtakasi/XRT/tests/unit-tests/xclbinutil/smartnic-format"
...
then
   /wrk/xhdhdnobkup5/mtakasi/XRT/src/runtime_src/tools/xclbinutil/unittests/SmartNic/SectionSmartNicFormat.py  --resource-dir /wrk/xhdhdnobkup5/mtakasi/XRT/src/runtime_src/tools/xclbinutil/unittests/SmartNic >> "$log_file" 2>&1
  errorCode=$?
fi
