...
# Working variables
log_file="runme.log"
setup_script="/wrk/xhdhdnobkup5/mtakasi/XRT/tests/setup.sh"
test_directory="/wrk/xhdhdnobkup5/mtakasi/XRT/tests/unit-tests/xclbinutil/partition_metadata"
...
then
   /wrk/xhdhdnobkup5/mtakasi/XRT/src/runtime_src/tools/xclbinutil/unittests/PartitionMetadata/SectionPartitionMetadata.py  --resource-dir /wrk/xhdhdnobkup5/mtakasi/XRT/src/runtime_src/tools/xclbinutil/unittests/PartitionMetadata >> "$log_file" 2>&1
  errorCode=$?
fi
