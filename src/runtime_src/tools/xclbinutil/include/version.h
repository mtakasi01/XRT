...
static const char xrt_build_version[] = "";
...
static const char xrt_build_version_date_rfc[] = "Sun, 29 Oct 2023 17:35:57 +0530";

static const char xrt_build_version_date[] = "2023-10-29 17:35:57";
...
#define XRT_VERSION_CODE XRT_VERSION(, )
#define XRT_MAJOR(code) ((code >> 16))
#define XRT_MINOR(code) (code - ((code >> 16) << 16))
#define XRT_PATCH 
#define XRT_HEAD_COMMITS 
#define XRT_BRANCH_COMMITS 
